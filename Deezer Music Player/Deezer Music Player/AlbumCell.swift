...
final class AlbumCell: UITableViewCell {
    ...
    private func setupConts() {
        ...
        NSLayoutConstraint.activate([
            albumimageView.leadingAnchor.constraint(equalToSystemSpacingAfter: myView.leadingAnchor, multiplier: 0.5),
            albumimageView.topAnchor.constraint(equalToSystemSpacingBelow: myView.topAnchor, multiplier: 0.5),
            albumimageView.bottomAnchor.constraint(equalToSystemSpacingBelow: myView.bottomAnchor, multiplier: -1),
        ...
        NSLayoutConstraint.activate([
            ...
            stackview.topAnchor.constraint(equalToSystemSpacingBelow: myView.topAnchor, multiplier: 1),
            stackview.trailingAnchor.constraint(equalToSystemSpacingAfter: myView.trailingAnchor, multiplier: 2),
            stackview.bottomAnchor.constraint(equalToSystemSpacingBelow: myView.bottomAnchor, multiplier: 1)
        ])
